...
function draw($row, $i)
{
    ...
    if ($row['switch'] == 1) {
        ...
        // Schiffe platzieren
        if ($e == 1) {
            echo "<a href='anlegen_01.php?switch=$s&port=$p&enabled=$e'><img src='schiff1.jpg' alt='up'></a>";
        } else {
            echo "<a href='anlegen_01.php?switch=$s&port=$p&enabled=$e'><img src='schiff3.jpg' alt='down'></a>";
        }
        echo " ";
...
<a href="spielen_01.php">Spiel beginnen</a>
